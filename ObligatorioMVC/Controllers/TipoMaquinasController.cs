...
namespace ObligatorioMVC.Controllers
{
    public class TipoMaquinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTipoMaquina,NombreTipoMaquina,Descripcion")] TipoMaquina tipoMaquina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoMaquina,NombreTipoMaquina,Descripcion")] TipoMaquina tipoMaquina)
        {
        ...
        {
            return _context.TipoMaquina.Any(e => e.IdTipoMaquina == id);
        }
    }
}
