...
namespace ObligatorioMVC.Controllers
{
    public class LocalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreLocal,Ciudad,Direccion,TelefonoLocal,IdResponsableLocal")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreLocal,Ciudad,Direccion,TelefonoLocal,IdResponsableLocal")] Local local)
        {
            if (id != local.Id)
            {
                return NotFound();
